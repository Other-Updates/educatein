...
class Institute_listing_third extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('institute-listing-three',$data);
    }
...
// activitys save
        ...
        $txt = "Hi Edugatein,
The spectrum package institute " . $_POST['institutename'] . " has been submitted by the user " . $user_name . ".Please check the details. Email : " . $user_email . "Mobile : " . $user_phone;
