...
class Add_listing_spectrum extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('add-listing-spectrum', $data);
    }
...
// gallery image save
        ...
        $txt = "Hi Edugatein,
            The spectrum package school " . $_POST['schoolname'] . " has been submitted by the user " . $user_name . ".Please check the details. Email : " . $user_email . "Mobile : " . $user_phone;
