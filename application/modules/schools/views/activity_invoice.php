    ...
    <thead>
        ...
        <tr>
            <th colspan="2" style="background:#fae6f0;text-align: center; padding: 10px; font-size: 25px;">
                <?php if($institute[0]['position_id'] == 1){ ?>
                Institute Platinum Package
                <?php } else if($institute[0]['position_id'] == 2){ ?>
                Institute Premium Package
                <?php } else if($institute[0]['position_id'] == 3){ ?>
                Institute Spectrum Package
                <?php } else if($institute[0]['position_id'] == 4) { ?>
                Institute Trial Package
                <?php } ?>
            </th>
        </tr>
    </thead>
    <tbody>
        <tr>
            ...
            <td style="text-align: right;">
                <b>Invoice</b><br>
                <?php $invoice_date = date('d-m-Y',strtotime($institute[0]['created_at'])); ?>
...
<table style="width: 80%; margin: 0 auto; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 30px;">
    ...
    <tbody>
        ...
        <?php } ?>
        <?php if($institute[0]['position_id'] == 2){ ?>
        <tr>
            <td style="padding: 10px; text-align: right;border-bottom: 1px solid #ddd;">ROUND OFF (-)</td>
