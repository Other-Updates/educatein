        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="new-signin-right">
                    <h1 class="display-4 mb-2">Enter Registration Details</h1>
                    <div class="row">
                        <div class="col-lg-9">
    ...
    <div class="dashboard-content">
        <div class="container">
            ...
            <div class="listing-section mat-30">
                <form action="<?php echo base_url() ?>schools/admin/insert_school" id="form1" method="post" enctype="multipart/form-data">
                    <div class="form-row">
