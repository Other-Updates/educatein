...
<form action="<?php echo base_url() ?>schools/admin_insert" method="post"  enctype="multipart/form-data"  id="signupschool" autocomplete="off">
    ...
    $(document).ready(function () {
        $(".formsubmit").on('click',function (event) {
            ...
            $.ajax({
                    ...
                    url: "<?php echo base_url("schools/email_exist") ?>",
                    dataType: "json",
