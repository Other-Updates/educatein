        ...
        <div class="row no-gutters">
            <div class="col-lg-4 col-sm-12">
                <div class="new-signin-left">
                    <a href="<?php echo base_url() ?>">
                        <img src="<?php echo base_url("assets/front/images/"); ?>dashboard/logo-white.png" class="w-100" alt="">                    </a>
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="new-signin-right">
                    <h1 class="display-4 mb-2">Parent Sign Up</h1>
                    <p>Create a new account to access various of services.</p>

                    <div class="row">
                        <div class="col-lg-9">
                            <form action="<?php echo base_url() ?>signup-parent/insert" method="post" onsubmit="myFunction()">
                                <div class="row">
                            ...
                            <p>Already Have an account? <a href="<?php echo base_url() ?>signin-parent" class="text-pink"><u>SIGN IN</u></a></p>
                        </div>
                    </div><!-- /row -->
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body p-5">
                        ...
                        <form action="<?php echo base_url() ?>signup-parent/otp" method="post" class="mt-3">
                            <div class="form-group">
                                <input type="text" class="form-control" name="otp" value="<?php echo @$ran; ?>" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="OTP">
                            </div>
