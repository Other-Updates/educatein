...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div><div class="form-row mb-2"><div class="col-lg-8 col-sm-6"><div class="input-group mb-3"><input type="file" accept="image/x-png,image/gif,image/jpeg" name="mytext[]"/></div></div><div class="col-lg-4 col-sm-6 remove_field"><a href="#" class="btn btn-danger" style="color:#fff!important;">Remove</a></div></div></div>'); //add input box
        }
    });
